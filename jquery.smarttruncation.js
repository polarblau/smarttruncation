  ...
  $.fn.smartTruncation = function(isFileName){
    if (typeof isFileName == 'undefined') isFileName = false; 
		return $(this).each(function(i, e){
			...
			// cache 
			if (!$(window).data('smarttruncation.sizecache')) 
			  $(window).data('smarttruncation.sizecache', {});
      ...
      var cacheKey = (function(s){var r="";for(k in s)r+=s[k];return r;})(fontAttributes);
      ...
      if ($(window).data('smarttruncation.sizecache')[cacheKey]) {
        ...
        // let's get the width of the most common characters
  			...
  			var $testWrapper = $('<span/>').css($.merge(fontAttributes, { 'visibility' : 'hidden' })).appendTo('body');
